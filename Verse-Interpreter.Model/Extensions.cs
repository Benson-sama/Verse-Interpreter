...
{
    public static IEnumerable<Variable> FreeVariables(this Expression expression, Expression? finalExpression = null)
    {
        VariableBuffer variableBuffer = new();
        expression.FreeVariables(variableBuffer, finalExpression);

        return variableBuffer.FreeVariables;
    }

    public static IEnumerable<Variable> FreeVariables(this Expression expression, VariableBuffer variableBuffer, Expression? finalExpression = null)
    {
